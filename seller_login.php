...
if (isset($_POST['submit'])) {
    ...
    $query = "SELECT id, name, email, logo, password FROM seller WHERE email = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $seller['password'])) {
            ...
            $_SESSION['success'] = "Welcome back, " . $_SESSION['seller_name'];
  ...
  <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-white relative">
    ...
    <div class="w-full max-w-[420px] flex flex-col mt-12 lg:mt-0">
      ...
      <div class="mb-8 text-center lg:text-left">
        <h2 class="text-3xl font-bold text-foreground mb-2">Welcome Back Seller</h2>
